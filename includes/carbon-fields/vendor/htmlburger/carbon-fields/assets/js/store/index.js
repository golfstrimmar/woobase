...
import { creatwoobase, combineReducers, applyMiddleware, compose } from 'redux';
...
export default function(state = {}, sagas = []) {
	...
	const store = creatwoobase(reducer, state, composeEnhancer(applyMiddleware(sagaMiddleware)));
